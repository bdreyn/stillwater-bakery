  ...
  main.innerHTML = `
    ...
    <section class="bg-linen/50">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 py-16 md:py-24 text-center fade-in">
        <h1 class="text-3xl md:text-5xl font-light text-bark leading-tight">
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        <div class="grid md:grid-cols-3 gap-8 text-center">
          <div class="fade-in">
            ...
            <h3 class="font-semibold text-bark mb-2">Made to Order</h3>
            <p class="text-bark-50 text-sm">Nothing sits on a shelf. Every item is baked fresh when you order it.</p>
          </div>
          <div class="fade-in">
            <div class="w-16 h-16 bg-sage/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <svg class="w-8 h-8 text-sage" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <h3 class="font-semibold text-bark mb-2">Local Ingredients</h3>
            <p class="text-bark-50 text-sm">Sourced from East Texas farms and producers whenever possible.</p>
          </div>
          <div class="fade-in">
            <div class="w-16 h-16 bg-sage/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <svg class="w-8 h-8 text-sage" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <h3 class="font-semibold text-bark mb-2">Small Batches</h3>
            <p class="text-bark-50 text-sm">Quality over quantity, always. Every item gets my full attention.</p>
          </div>
        </div>
      </div>
    </section>
